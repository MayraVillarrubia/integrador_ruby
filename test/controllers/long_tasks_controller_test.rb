...
class LongTasksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create long_task" do
    assert_difference('LongTask.count') do
      post long_tasks_url, params: { long_task: { percentage_completion: @long_task.percentage_completion } }
    end
  ...
  test "should update long_task" do
    patch long_task_url(@long_task), params: { long_task: { percentage_completion: @long_task.percentage_completion } }
